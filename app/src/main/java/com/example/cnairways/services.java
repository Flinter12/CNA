...
public class    services extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buyticket).setOnClickListener(v -> {
            Intent intent = new Intent(this, ticket.class);
            intent.putExtra("passengerId", passengerId);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        });
        findViewById(R.id.tablo).setOnClickListener(v -> {
            Intent intent = new Intent(this, onlinetablo.class);
            intent.putExtra("passengerId", passengerId);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        });
        findViewById(R.id.napravlenia2).setOnClickListener(v -> {
            Intent intent = new Intent(this, napravlenia.class);
            intent.putExtra("passengerId", passengerId);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        });
        findViewById(R.id.oplata).setOnClickListener(v -> {
            Intent intent = new Intent(this, oplata.class);
            intent.putExtra("passengerId", passengerId);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
        });
        findViewById(R.id.yslygi).setOnClickListener(v -> {
