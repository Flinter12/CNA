...
public class onlinetablo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onlinetablo);
        ...
        ArrayAdapter<String> autoCompleteAdapter = new ArrayAdapter<>(this, android.R.layout.simple_dropdown_item_1line, pagesList);
        searchEditText.setAdapter(autoCompleteAdapter);

        recyclerView = findViewById(R.id.flightsRecyclerView);
    ...
    private void loadFlights() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(onlinetablo.this, "Ошибка загрузки данных", Toast.LENGTH_SHORT).show();
            }
        });
    }
